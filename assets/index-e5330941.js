 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lu="FirebaseError";class ae extends Error{constructor(t,n,s){super(n),this.code=t,this.customData=s,this.name=lu,Object.setPrototypeOf(this,ae.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,wo.prototype.create)}}class wo{constructor(t,n,s){this.service=t,this.serviceName=n,this.errors=s}create(t,...n){const s=n[0]||{},i=`${this.service}/${t}`,r=this.errors[t],o=r?du(r,s):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new ae(i,a,s)}}function du(e,t){return e.replace(fu,(n,s)=>{const i=t[s];return i!=null?String(i):`<${s}?>`})}const fu=/\{\$([^}]+)}/g;function Rs(e,t){if(e===t)return!0;const n=Object.keys(e),s=Object.keys(t);for(const i of n){if(!s.includes(i))return!1;const r=e[i],o=t[i];if(or(r)&&or(o)){if(!Rs(r,o))return!1}else if(r!==o)return!1}for(const i of s)if(!n.includes(i))return!1;return!0}function or(e){return e!==null&&typeof e=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fh="firebase-heartbeat-database",ph=1,Ce="firebase-heartbeat-store";let ws=null;function So(){return ws||(ws=ku(fh,ph,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(Ce)}}}).catch(e=>{throw wt.create("idb-open",{originalErrorMessage:e.message})})),ws}async function gh(e){try{return(await So()).transaction(Ce).objectStore(Ce).get(bo(e))}catch(t){if(t instanceof ae)Lt.warn(t.message);else{const n=wt.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});Lt.warn(n.message)}}}async function lr(e,t){try{const s=(await So()).transaction(Ce,"readwrite");return await s.objectStore(Ce).put(t,bo(e)),s.done}catch(n){if(n instanceof ae)Lt.warn(n.message);else{const s=wt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Lt.warn(s.message)}}}function bo(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Na=class{static R(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",n=Math.floor(256/t.length)*t.length;let s="";for(;s.length<20;){const i=Ml(40);for(let r=0;r<i.length;++r)s.length<20&&i[r]<n&&(s+=t.charAt(i[r]%t.length))}return s}};function N(e,t){return e<t?-1:e>t?1:0}function Xt(e,t,n){return e.length===t.length&&e.every((s,i)=>n(s,t[i]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Z{constructor(t){this.binaryString=t}static fromBase64String(t){const n=function(s){try{return atob(s)}catch(i){throw i instanceof DOMException?new jl("Invalid base64 string: "+i):i}}(t);return new Z(n)}static fromUint8Array(t){const n=function(s){let i="";for(let r=0;r<s.length;++r)i+=String.fromCharCode(s[r]);return i}(t);return new Z(n)}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return t=this.binaryString,btoa(t);var t}toUint8Array(){return function(t){const n=new Uint8Array(t.length);for(let s=0;s<t.length;s++)n[s]=t.charCodeAt(s);return n}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return N(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}Z.EMPTY_BYTE_STRING=new Z("");const ql=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function At(e){if(x(!!e),typeof e=="string"){let t=0;const n=ql.exec(e);if(x(!!n),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),t=Number(i)}const s=new Date(e);return{seconds:Math.floor(s.getTime()/1e3),nanos:t}}return{seconds:$(e.seconds),nanos:$(e.nanos)}}function $(e){return typeof e=="number"?e:typeof e=="string"?Number(e):0}function Yt(e){return typeof e=="string"?Z.fromBase64String(e):Z.fromUint8Array(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rn{constructor(t,n){this.position=t,this.inclusive=n}}function Or(e,t,n){let s=0;for(let i=0;i<e.position.length;i++){const r=t[i],o=e.position[i];if(r.field.isKeyField()?s=E.comparator(E.fromName(o.referenceValue),n.key):s=Jt(o,n.data.field(r.field)),r.dir==="desc"&&(s*=-1),s!==0)break}return s}function Lr(e,t){if(e===null)return t===null;if(t===null||e.inclusive!==t.inclusive||e.position.length!==t.position.length)return!1;for(let n=0;n<e.position.length;n++)if(!ht(e.position[n],t.position[n]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Te{constructor(t,n="asc"){this.field=t,this.dir=n}}function Zl(e,t){return e.dir===t.dir&&e.field.isEqual(t.field)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class le{constructor(t,n){this.mapKeyFn=t,this.equalsFn=n,this.inner={},this.innerSize=0}get(t){const n=this.mapKeyFn(t),s=this.inner[n];if(s!==void 0){for(const[i,r]of s)if(this.equalsFn(i,t))return r}}has(t){return this.get(t)!==void 0}set(t,n){const s=this.mapKeyFn(t),i=this.inner[s];if(i===void 0)return this.inner[s]=[[t,n]],void this.innerSize++;for(let r=0;r<i.length;r++)if(this.equalsFn(i[r][0],t))return void(i[r]=[t,n]);i.push([t,n]),this.innerSize++}delete(t){const n=this.mapKeyFn(t),s=this.inner[n];if(s===void 0)return!1;for(let i=0;i<s.length;i++)if(this.equalsFn(s[i][0],t))return s.length===1?delete this.inner[n]:s.splice(i,1),this.innerSize--,!0;return!1}forEach(t){Vt(this.inner,(n,s)=>{for(const[i,r]of s)t(i,r)})}isEmpty(){return ka(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pd=new U(E.comparator);function mt(){return pd}const ec=new U(E.comparator);function ve(...e){let t=ec;for(const n of e)t=t.insert(n.key,n);return t}function nc(e){let t=ec;return e.forEach((n,s)=>t=t.insert(n,s.overlayedDocument)),t}function Rt(){return Ae()}function sc(){return Ae()}function Ae(){return new le(e=>e.toString(),(e,t)=>e.isEqual(t))}const gd=new U(E.comparator),md=new V(E.comparator);function C(...e){let t=md;for(const n of e)t=t.add(n);return t}const yd=new V(N);function ic(){return yd}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gn{constructor(t,n){this.hasPendingWrites=t,this.fromCache=n}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class Np extends Uc{constructor(t,n,s,i,r,o){super(t,n,s,i,o),this._firestore=t,this._firestoreImpl=t,this.metadata=r}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const n=new wn(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,n={}){if(this._document){const s=this._document.data.field(nr("DocumentSnapshot.get",t));if(s!==null)return this._userDataWriter.convertValue(s,n.serverTimestamps)}}}class wn extends Np{data(t={}){return super.data(t)}}class kp{constructor(t,n,s,i){this._firestore=t,this._userDataWriter=n,this._snapshot=i,this.metadata=new gn(i.hasPendingWrites,i.fromCache),this.query=s}get docs(){const t=[];return this.forEach(n=>t.push(n)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,n){this._snapshot.docs.forEach(s=>{t.call(n,new wn(this._firestore,this._userDataWriter,s.key,s,new gn(this._snapshot.mutatedKeys.has(s.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const n=!!t.includeMetadataChanges;if(n&&this._snapshot.excludesMetadataChanges)throw new m(f.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===n||(this._cachedChanges=function(s,i){if(s._snapshot.oldDocs.isEmpty()){let r=0;return s._snapshot.docChanges.map(o=>{const a=new wn(s._firestore,s._userDataWriter,o.doc.key,o.doc,new gn(s._snapshot.mutatedKeys.has(o.doc.key),s._snapshot.fromCache),s.query.converter);return o.doc,{type:"added",doc:a,oldIndex:-1,newIndex:r++}})}{let r=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(o=>i||o.type!==3).map(o=>{const a=new wn(s._firestore,s._userDataWriter,o.doc.key,o.doc,new gn(s._snapshot.mutatedKeys.has(o.doc.key),s._snapshot.fromCache),s.query.converter);let c=-1,u=-1;return o.type!==0&&(c=r.indexOf(o.doc.key),r=r.delete(o.doc.key)),o.type!==1&&(r=r.add(o.doc),u=r.indexOf(o.doc.key)),{type:xp(o.type),doc:a,oldIndex:c,newIndex:u}})}}(this,n),this._cachedChangesIncludeMetadataChanges=n),this._cachedChanges}}function xp(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return T()}}class Rp extends _p{constructor(t){super(),this.firestore=t}convertBytes(t){return new se(t)}convertReference(t){const n=this.convertDocumentKey(t,this.firestore._databaseId);return new it(this.firestore,null,n)}}function Mp(e){e=ne(e,fe);const t=ne(e.firestore,ls),n=Mc(t),s=new Rp(t);return Ip(e._query),ap(n,e._query).then(i=>new kp(t,s,e,i))}function Op(e,t,n,...s){e=ne(e,it);const i=ne(e.firestore,ls),r=Zi(i);let o;return o=typeof(t=dt(t))=="string"||t instanceof ds?vp(r,"updateDoc",e._key,t,n,s):yp(r,"updateDoc",e._key,t),jc(i,[o.toMutation(e._key,ct.exists(!0))])}function Lp(e,t){const n=ne(e.firestore,ls),s=Rc(e),i=Dp(e.converter,t);return jc(n,[mp(Zi(e.firestore),"addDoc",s._key,i,e.converter!==null,{}).toMutation(s._key,ct.exists(!1))]).then(()=>s)}function jc(e,t){return function(n,s){const i=new Et;return n.asyncQueue.enqueueAndForget(async()=>qf(await rp(n),s,i)),i.promise}(Mc(e),t)}(function(e,t=!0){(function(n){he=n})(lh),In(new be("firestore",(n,{instanceIdentifier:s,options:i})=>{const r=n.getProvider("app").getImmediate(),o=new ls(new Dl(n.getProvider("auth-internal")),new Rl(n.getProvider("app-check-internal")),function(a,c){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new m(f.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Me(a.options.projectId,c)}(r,s),r);return i=Object.assign({useFetchStreams:t},i),o._setSettings(i),o},"PUBLIC").setMultipleInstances(!0)),Kt(_r,"3.8.4",e),Kt(_r,"3.8.4","esm2017")})();/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ks;const Pn=window,ie=Pn.trustedTypes,oo=ie?ie.createPolicy("lit-html",{createHTML:e=>e}):void 0,yt=`lit$${(Math.random()+"").slice(9)}$`,qc="?"+yt,$p=`<${qc}>`,re=document,Pe=(e="")=>re.createComment(e),Ve=e=>e===null||typeof e!="object"&&typeof e!="function",Hc=Array.isArray,Fp=e=>Hc(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",ge=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ao=/-->/g,co=/>/g,Dt=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),uo=/'/g,ho=/"/g,Kc=/^(?:script|style|textarea|title)$/i,Pp=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),lo=Pp(1),Ue=Symbol.for("lit-noChange"),j=Symbol.for("lit-nothing"),fo=new WeakMap,Qt=re.createTreeWalker(re,129,null,!1),Vp=(e,t)=>{const n=e.length-1,s=[];let i,r=t===2?"<svg>":"",o=ge;for(let c=0;c<n;c++){const u=e[c];let h,l,d=-1,g=0;for(;g<u.length&&(o.lastIndex=g,l=o.exec(u),l!==null);)g=o.lastIndex,o===ge?l[1]==="!--"?o=ao:l[1]!==void 0?o=co:l[2]!==void 0?(Kc.test(l[2])&&(i=RegExp("</"+l[2],"g")),o=Dt):l[3]!==void 0&&(o=Dt):o===Dt?l[0]===">"?(o=i??ge,d=-1):l[1]===void 0?d=-2:(d=o.lastIndex-l[2].length,h=l[1],o=l[3]===void 0?Dt:l[3]==='"'?ho:uo):o===ho||o===uo?o=Dt:o===ao||o===co?o=ge:(o=Dt,i=void 0);const w=o===Dt&&e[c+1].startsWith("/>")?" ":"";r+=o===ge?u+$p:d>=0?(s.push(h),u.slice(0,d)+"$lit$"+u.slice(d)+yt+w):u+yt+(d===-2?(s.push(void 0),c):w)}const a=r+(e[n]||"<?>")+(t===2?"</svg>":"");if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return[oo!==void 0?oo.createHTML(a):a,s]};class Be{constructor({strings:t,_$litType$:n},s){let i;this.parts=[];let r=0,o=0;const a=t.length-1,c=this.parts,[u,h]=Vp(t,n);if(this.el=Be.createElement(u,s),Qt.currentNode=this.el.content,n===2){const l=this.el.content,d=l.firstChild;d.remove(),l.append(...d.childNodes)}for(;(i=Qt.nextNode())!==null&&c.length<a;){if(i.nodeType===1){if(i.hasAttributes()){const l=[];for(const d of i.getAttributeNames())if(d.endsWith("$lit$")||d.startsWith(yt)){const g=h[o++];if(l.push(d),g!==void 0){const w=i.getAttribute(g.toLowerCase()+"$lit$").split(yt),S=/([.?@])?(.*)/.exec(g);c.push({type:1,index:r,name:S[2],strings:w,ctor:S[1]==="."?Bp:S[1]==="?"?qp:S[1]==="@"?Hp:gs})}else c.push({type:6,index:r})}for(const d of l)i.removeAttribute(d)}if(Kc.test(i.tagName)){const l=i.textContent.split(yt),d=l.length-1;if(d>0){i.textContent=ie?ie.emptyScript:"";for(let g=0;g<d;g++)i.append(l[g],Pe()),Qt.nextNode(),c.push({type:2,index:++r});i.append(l[d],Pe())}}}else if(i.nodeType===8)if(i.data===qc)c.push({type:2,index:r});else{let l=-1;for(;(l=i.data.indexOf(yt,l+1))!==-1;)c.push({type:7,index:r}),l+=yt.length-1}r++}}static createElement(t,n){const s=re.createElement("template");return s.innerHTML=t,s}}function oe(e,t,n=e,s){var i,r,o,a;if(t===Ue)return t;let c=s!==void 0?(i=n._$Co)===null||i===void 0?void 0:i[s]:n._$Cl;const u=Ve(t)?void 0:t._$litDirective$;return(c==null?void 0:c.constructor)!==u&&((r=c==null?void 0:c._$AO)===null||r===void 0||r.call(c,!1),u===void 0?c=void 0:(c=new u(e),c._$AT(e,n,s)),s!==void 0?((o=(a=n)._$Co)!==null&&o!==void 0?o:a._$Co=[])[s]=c:n._$Cl=c),c!==void 0&&(t=oe(e,c._$AS(e,t.values),c,s)),t}class Up{constructor(t,n){this.u=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(t){var n;const{el:{content:s},parts:i}=this._$AD,r=((n=t==null?void 0:t.creationScope)!==null&&n!==void 0?n:re).importNode(s,!0);Qt.currentNode=r;let o=Qt.nextNode(),a=0,c=0,u=i[0];for(;u!==void 0;){if(a===u.index){let h;u.type===2?h=new on(o,o.nextSibling,this,t):u.type===1?h=new u.ctor(o,u.name,u.strings,this,t):u.type===6&&(h=new Kp(o,this,t)),this.u.push(h),u=i[++c]}a!==(u==null?void 0:u.index)&&(o=Qt.nextNode(),a++)}return r}p(t){let n=0;for(const s of this.u)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,n),n+=s.strings.length-2):s._$AI(t[n])),n++}}class on{constructor(t,n,s,i){var r;this.type=2,this._$AH=j,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=s,this.options=i,this._$Cm=(r=i==null?void 0:i.isConnected)===null||r===void 0||r}get _$AU(){var t,n;return(n=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&n!==void 0?n:this._$Cm}get parentNode(){let t=this._$AA.parentNode;const n=this._$AM;return n!==void 0&&t.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=oe(this,t,n),Ve(t)?t===j||t==null||t===""?(this._$AH!==j&&this._$AR(),this._$AH=j):t!==this._$AH&&t!==Ue&&this.g(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Fp(t)?this.k(t):this.g(t)}O(t,n=this._$AB){return this._$AA.parentNode.insertBefore(t,n)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}g(t){this._$AH!==j&&Ve(this._$AH)?this._$AA.nextSibling.data=t:this.T(re.createTextNode(t)),this._$AH=t}$(t){var n;const{values:s,_$litType$:i}=t,r=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=Be.createElement(i.h,this.options)),i);if(((n=this._$AH)===null||n===void 0?void 0:n._$AD)===r)this._$AH.p(s);else{const o=new Up(r,this),a=o.v(this.options);o.p(s),this.T(a),this._$AH=o}}_$AC(t){let n=fo.get(t.strings);return n===void 0&&fo.set(t.strings,n=new Be(t)),n}k(t){Hc(this._$AH)||(this._$AH=[],this._$AR());const n=this._$AH;let s,i=0;for(const r of t)i===n.length?n.push(s=new on(this.O(Pe()),this.O(Pe()),this,this.options)):s=n[i],s._$AI(r),i++;i<n.length&&(this._$AR(s&&s._$AB.nextSibling,i),n.length=i)}_$AR(t=this._$AA.nextSibling,n){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,n);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var n;this._$AM===void 0&&(this._$Cm=t,(n=this._$AP)===null||n===void 0||n.call(this,t))}}class gs{constructor(t,n,s,i,r){this.type=1,this._$AH=j,this._$AN=void 0,this.element=t,this.name=n,this._$AM=i,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=j}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,n=this,s,i){const r=this.strings;let o=!1;if(r===void 0)t=oe(this,t,n,0),o=!Ve(t)||t!==this._$AH&&t!==Ue,o&&(this._$AH=t);else{const a=t;let c,u;for(t=r[0],c=0;c<r.length-1;c++)u=oe(this,a[s+c],n,c),u===Ue&&(u=this._$AH[c]),o||(o=!Ve(u)||u!==this._$AH[c]),u===j?t=j:t!==j&&(t+=(u??"")+r[c+1]),this._$AH[c]=u}o&&!i&&this.j(t)}j(t){t===j?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Bp extends gs{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===j?void 0:t}}const jp=ie?ie.emptyScript:"";class qp extends gs{constructor(){super(...arguments),this.type=4}j(t){t&&t!==j?this.element.setAttribute(this.name,jp):this.element.removeAttribute(this.name)}}class Hp extends gs{constructor(t,n,s,i,r){super(t,n,s,i,r),this.type=5}_$AI(t,n=this){var s;if((t=(s=oe(this,t,n,0))!==null&&s!==void 0?s:j)===Ue)return;const i=this._$AH,r=t===j&&i!==j||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,o=t!==j&&(i===j||r);r&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var n,s;typeof this._$AH=="function"?this._$AH.call((s=(n=this.options)===null||n===void 0?void 0:n.host)!==null&&s!==void 0?s:this.element,t):this._$AH.handleEvent(t)}}class Kp{constructor(t,n,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){oe(this,t)}}const po=Pn.litHtmlPolyfillSupport;po==null||po(Be,on),((ks=Pn.litHtmlVersions)!==null&&ks!==void 0?ks:Pn.litHtmlVersions=[]).push("2.6.1");const zc=(e,t,n)=>{var s,i;const r=(s=n==null?void 0:n.renderBefore)!==null&&s!==void 0?s:t;let o=r._$litPart$;if(o===void 0){const a=(i=n==null?void 0:n.renderBefore)!==null&&i!==void 0?i:null;r._$litPart$=o=new on(t.insertBefore(Pe(),a),a,void 0,n??{})}return o._$AI(e),o},zp={apiKey:"AIzaSyB5UX2SHZ4Mzc1XvF5UgDvTGd4WLwBOsQc",authDomain:"job-search-website-vz.firebaseapp.com",databaseURL:"https://job-search-website-vz-default-rtdb.firebaseio.com",projectId:"job-search-website-vz",storageBucket:"job-search-website-vz.appspot.com",messagingSenderId:"885937389036",appId:"1:885937389036:web:4321a4b35e152aab6554c9",measurementId:"G-4NSDHCC0QM"},Gp=Ao(zp),Gc=dp(Gp),go=hp(Gc,"user");let xs="",Se=[],ui="";function Qc(e){return lo`
        ${e.map(t=>lo`
            <div class="job">
                <div>${t.title}</div>
    ...
    `}document.getElementById("login-btn").addEventListener("click",async()=>{document.querySelector(".job-list");let e=document.getElementById("username").value;try{const t=Sp(go,bp("username","==",e)),n=await Mp(t);n.docs.length===0?(await Lp(go,{username:e,jobs:[]}).then(s=>{ui=s.id}),xs=e):(xs=n.docs[0].data().username,Se=n.docs[0].data().jobs,ui=n.docs[0].id),document.getElementById("loggedin-username").textContent="Welcome! "+xs,zc(Qc(Se),document.querySelector(".job-list"))}catch(t){console.log("error on login/sign up:",t)}});document.getElementById("add-job-btn").addEventListener("click",async()=>{const e={title:document.getElementById("job-title").value,companyName:document.getElementById("company-name").value,jdLink:document.getElementById("jd-link").value,status:document.getElementById("status").value};Se.push(e);try{await Op(Rc(Gc,"user",ui),{jobs:Se}),zc(Qc(Se),document.querySelector(".job-list"))}catch(t){console.log("failed to add the job:",t)}});
